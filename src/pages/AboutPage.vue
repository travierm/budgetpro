<template>
    <div class="flex gap-4 justify-center p-4">
        <div class="w-3/4 bg-gray-800 shadow-lg rounded-lg p-4 text-white">
            ...
            <br />
            <p>BudgetPro keeps it simple. Provide a small amount of data, and we can calculate great insights into
                your
                finances without ever sending your data to a server.</p>
            ...
            <br />
            <p class="text-center">Designed and build by <a target="_blank" class="text-blue-400"
